    ...
    <div className="min-h-[80vh] flex items-center justify-center p-4 relative overflow-hidden">
      ...
      >
        <div className="text-center">
          ...
          <p className="text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 transition-colors">
        ...
        <form className="space-y-3 sm:space-y-4" onSubmit={handleSubmit}>
          ...
          <div className="space-y-2 sm:space-y-3">
            {!isLogin && (
              <>
                <div>
                  <label className="block text-[10px] sm:text-xs font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors">Full Name</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
                      <User className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400 dark:text-gray-500 transition-colors" />
                    </div>
                    <input
                      type="text"
                      required={!isLogin}
                      ...
                      className="pl-7 sm:pl-8 w-full px-3 py-1.5 sm:py-2 bg-gray-50 dark:bg-gray-800 border border-gray-300 dark:border-gray-700 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all text-gray-900 dark:text-white outline-none text-xs sm:text-sm placeholder-gray-400 dark:placeholder-gray-500"
                      placeholder="John Doe"
                    />
                  </div>
                </div>
                <div>
                  <label className="block text-[10px] sm:text-xs font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors">Email Address</label>
                  <div className="relative">
                    <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
                      <Mail className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400 dark:text-gray-500 transition-colors" />
                    </div>
                    <input
                      type="email"
                      required={!isLogin}
            ...
            {isLogin && (
              <div>
                <label className="block text-[10px] sm:text-xs font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors">Username / Email</label>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
                    <User className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400 dark:text-gray-500 transition-colors" />
                  </div>
            ...
            <div>
              <label className="block text-[10px] sm:text-xs font-medium text-gray-700 dark:text-gray-300 mb-1 transition-colors">Password</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-2 flex items-center pointer-events-none">
                  <Lock className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-gray-400 dark:text-gray-500 transition-colors" />
                </div>
                <input
                  type="password"
                  required
          ...
          {isLogin && (
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                ...
                <label htmlFor="remember-me" className="ml-1.5 block text-[10px] sm:text-xs text-gray-500 dark:text-gray-400 transition-colors">Remember me</label>
              </div>
          ...
          >
            <span className="absolute left-0 inset-y-0 flex items-center pl-2">
              <LogIn className="h-3.5 w-3.5 text-blue-300 group-hover:text-blue-200 transition-colors" />
            </span>
          ...
          <Link href="/admin-login" className="block">
            ...
            >
              <div className="flex items-center justify-center w-7 h-7 sm:w-8 sm:h-8 rounded-lg bg-gradient-to-br from-red-100 to-orange-100 dark:from-red-600/20 dark:to-orange-600/20 group-hover:from-red-200 group-hover:to-orange-200 dark:hover:from-red-600/30 dark:hover:to-orange-600/30 transition-colors">
                <Shield className="h-3.5 w-3.5 sm:h-4 sm:w-4 text-red-600 dark:text-red-400 group-hover:text-red-700 dark:group-hover:text-red-300 transition-colors" />
              </div>
              <div className="flex-1 text-left">
                <p className="text-xs sm:text-sm font-medium text-gray-900 dark:text-gray-300 group-hover:text-red-700 dark:group-hover:text-white transition-colors">
                  Admin Access
                </p>
              </div>
